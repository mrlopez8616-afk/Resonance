...
- `/calendar` — operating calendar. Day is the default, with Week and Month. Lanes: Cadence, Capital, Build, Gates, plus node-tagged catalysts. Same Blob cabinet as fills (`resonance-2/calendar.json`) and the same Bearer secret. See [`cabinet/operating-calendar.md`](cabinet/operating-calendar.md).
