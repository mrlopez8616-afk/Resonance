...
Sleeve files stay on disk (soft-archive: hidden from the floor, not deleted). Restoring XRP, SUI, or PWR re-stands the live face from those files. Restoring an offline ticker brings the dashed placeholder back.
