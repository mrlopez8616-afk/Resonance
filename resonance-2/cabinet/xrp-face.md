...
SUI and PWR are already live. ETN (second equity) is [`etn-face.md`](./etn-face.md). VRT (third equity) is [`vrt-face.md`](./vrt-face.md). Shared extract lives in [`sui-face.md`](./sui-face.md). Equity rules: [`pwr-face.md`](./pwr-face.md).
...
- `live` — solid red rim (XRP, SUI, PWR, ETN, and VRT in this brick)
...
Fill ingest (RH + Coinbase → operator log + sleeve print) is [`fill-ingest.md`](./fill-ingest.md). SUI reuse is [`sui-face.md`](./sui-face.md). PWR equity reuse is [`pwr-face.md`](./pwr-face.md). ETN equity reuse is [`etn-face.md`](./etn-face.md). VRT equity reuse is [`vrt-face.md`](./vrt-face.md). Register a crypto ticker in `SPOT_TICKERS` only when a public crypto spot feed exists. Equities use `equity-price.ts`, not CoinGecko.
