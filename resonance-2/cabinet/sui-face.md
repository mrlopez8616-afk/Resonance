...
SUI is the second live node. PWR (equity) is the third — start at [`pwr-face.md`](./pwr-face.md). ETN is the fourth — [`etn-face.md`](./etn-face.md). VRT is the fifth — [`vrt-face.md`](./vrt-face.md). GEV, CEG, and HUBB are the remaining equity batch — [`gev-face.md`](./gev-face.md), [`ceg-face.md`](./ceg-face.md), [`hubb-face.md`](./hubb-face.md). Do not copy-paste a new face component.
...
3. Register the ticker in `SPOT_TICKERS` **only if** it has a public crypto spot USD feed. Equities reuse `src/lib/equity-price.ts` — do not pretend CoinGecko has PWR, ETN, VRT, GEV, CEG, or HUBB.
